...
install() {
    bash <(curl -Ls https://raw.githubusercontent.com/MetaQuest/3x-ui-Apline/refs/heads/main/install_alpine.sh)
    if [[ $? == 0 ]]; then
        if [[ $# == 0 ]]; then
            start
        else
...
update_menu() {
    ...
    wget --no-check-certificate -O /usr/bin/x-ui https://raw.githubusercontent.com/MetaQuest/3x-ui-Apline/refs/heads/main/x-ui-alpine.sh
...
legacy_version() {
    ...
    install_command="bash <(curl -Ls "https://raw.githubusercontent.com/MetaQuest/3x-ui-Apline/v$tag_version/install_alpine.sh") v$tag_version"
...
uninstall() {
    ...
    echo -e "${green}bash <(curl -Ls https://raw.githubusercontent.com/MetaQuest/3x-ui-Apline/refs/heads/main/install_alpine.sh)${plain}"
    echo ""
...
update_shell() {
    wget -O /usr/bin/x-ui -N --no-check-certificate https://raw.githubusercontent.com/MetaQuest/3x-ui-Apline/refs/heads/main/x-ui-alpine.sh
    if [[ $? != 0 ]]; then
        echo ""
